...
(function () {
  ...
  var makeIconMasking = function (_ref) {
    ...
    var trans = transformForSvg({ transform, containerWidth: maskWidth, iconWidth: mainWidth });
  ...
  var makeIconStandard = function (_ref) {
    ...
    if (transformIsMeaningful(transform)) {
      var trans = transformForSvg({ transform, containerWidth: main.width, iconWidth: main.width });
      children.push({
        tag: 'g',
        attributes: _extends({}, trans.outer),
        children: [ {
  ...
  function makeLayersTextAbstract(params) {
    ...
    var attributes = _extends({}, extra.attributes, title ? { title } : {}, {
    ...
    if (transformIsMeaningful(transform)) {
      styles['transform'] = transformForCss({ transform, startCentered: true, width, height });
 ...
 */
  ...
  var counter = function counter(content) {
    ...
    return apiObject({ type: 'counter', content }, function () {
      ensureCss();
