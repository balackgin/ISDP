<template>
  <div>
    <el-collapse-item name="3">
      ...
      <div class="riskPresent" v-if="activeName==3&&this.riskDetailData.isClosed!=1">
        <el-form
        ...
        >
          <el-form-item
            ...
            label="进展详情："
            prop="riskProgressDetail"
          >
            <div
              class="riskPresent_item_detail"
              v-if="riskDetailData.progressLogArray&&riskDetailData.progressLogArray.length>0"
            >
              <div
                class="riskPresent_item_detail_list"
                v-for="item of riskDetailData.progressLogArray"
                :key="item.id"
              >
                <span class="riskPresent_item_detail_list_info">{{item.detail}}</span>
                <span class="riskPresent_item_detail_list_time">{{item.createDate}}</span>
              </div>
            </div>
            <el-input
              type="textarea"
              ...
              placeholder="请输入问题描述"
              v-model="riskDetailData.riskProgressDetail"
            ></el-input>
            <span class="limitLength" v-if="!riskDetailData.riskProgressDetail">0/200</span>
            <span
              class="limitLength"
              v-if="riskDetailData.riskProgressDetail"
            >{{riskDetailData.riskProgressDetail.length}}/200</span>
          </el-form-item>
          ...
          <el-form-item class="riskPresent_item detailDescribe noRequire" label="备注：">
            <el-input
              ...
              class="describeTextarea"
              placeholder="请输入备注"
              v-model="riskDetailData.progressMemo"
            ></el-input>
            <span
              class="limitLength"
              v-if="riskDetailData.progressMemo"
            >{{riskDetailData.progressMemo.length}}/200</span>
            <span class="limitLength" v-if="!riskDetailData.progressMemo">0/200</span>
          </el-form-item>
        </el-form>
      </div>
      <div class="riskPresent" v-if="activeName==4||this.riskDetailData.isClosed==1">
        <el-form
          :model="riskDetailData"
          :rules="rules"
          ref="riskDetailData"
        ...
        >
          ...
          <el-form-item class="riskPresent_item riskPresent_detail detailDescribe" label="备注：">
            <span
